...
import { WomenHealthPackagesPagesData } from './womens-packages-pages.model'
...
export function extractComponent(
  ...
  return {
    banner: {
      ...
      path: `Home > Womens Health Packages > ${data.name}`,
    },
    testSection: {
...
export const getwomenPackagesPagesData = async (
  category: number
